...
{
    setupAction.AddSecurityDefinition("MayoristaApiBearerAuth", new OpenApiSecurityScheme() //Esto va a permitir usar swagger con el token.
    {
    ...
    {
        {
            new OpenApiSecurityScheme
            {
                Reference = new OpenApiReference
                {
                    ...
                    Id = "MayoristaApiBearerAuth" } //Tiene que coincidir con el id seteado arriba en la definición
                }, new List<string>() }
    });
...
string connectionString = builder.Configuration["ConnectionStrings:ProductsDBConnectionString"]!;
